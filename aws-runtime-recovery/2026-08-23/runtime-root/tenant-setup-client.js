(() => {
  ...
  const state = {
    ...
    shiftLayoutWidth: 0,
    businessSchedule: { openMinutes: 600, closeMinutes: 1140, closedWeekdays: [1], isClosed: false, capacity: 1 },
    dailyScheduleDate: '',
  ...
  function openManualAppointmentFromLane(event, lane) {
    ...
    if (!canvas || !launcher || startMinutes == null) return
    event.preventDefault()
...
;(() => {
  ...
  const load = () => {
    ...
    script.src = '/customer-merge-v385.js?v=386'
