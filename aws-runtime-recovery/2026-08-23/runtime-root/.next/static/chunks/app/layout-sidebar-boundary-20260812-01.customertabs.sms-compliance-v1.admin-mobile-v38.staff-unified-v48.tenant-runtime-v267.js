try{document.documentElement.dataset.caTheme=localStorage.getItem("salon-lien:admin-theme")==="dark"?"dark":"pink"}catch{};
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3185],
  {
    4235: function (e, t, n) {
      (Promise.resolve().then(n.t.bind(n, 2778, 23)),
        Promise.resolve().then(n.bind(n, 16)));
    },
    7648: function (e, t, n) {
      "use strict";
      n.d(t, {
    ...
    16: function (e, t, n) {
      ...
      function j(e) {
        let {
            ...
            className: n = "",
            imageClassName: s = "",
            sizes: r = "(max-width: 768px) 100vw, 420px",
            priority: l = !1,
            children: i,
            overlay: o = "soft",
          } = e,
        ...
        return (0, a.jsxs)("figure", {
          className: k("relative isolate overflow-hidden bg-[#efe5da]", n),
          children: [
            (0, a.jsx)(y(), {
              src: c.src,
              alt: c.alt,
      ...
      let N = [
          { href: "/admin/appointments", label: "予約カレンダー", icon: l.Z },
          { href: "/admin/customers", label: "顧客・チャット・配信", icon: o },
          {
      ...
      function Z(e) {
        ...
        return {
          path: n,
          view:
            null !== (t = new URLSearchParams(a).get("view")) && void 0 !== t
              ? t
              : "",
        };
      }
      function S(e, t, n) {
        let { path: a, view: s } = Z(n);
        return s
          ? e === a && t === s
          : "/admin/customers" === a
            ? e === a
            ...
            : e === a || e.startsWith("".concat(a, "/"));
      }
      function L(e) {
        let { imageUrl: t, compact: n = !1 } = e;
        return (0, a.jsx)("span", {
          role: "img",
          "aria-label": "店舗アイコン",
          className: "".concat(
            ...
            " inline-flex shrink-0 items-center justify-center border border-[#ead8ca] bg-[#fff7ef] bg-cover bg-center font-semibold text-[color:var(--lien-primary-dark)] shadow-sm",
          ),
          style: { backgroundImage: "url(/brand/salon-customer-service-mark.svg)" },
          children: (0, a.jsx)("span", {
            className: "sr-only",
            children: "Salon customer servitomer service",
          }),
        });
      }
      function z(e) {
        let { displayName: t, compact: n = !1 } = e;
        return t
          ? (0, a.jsxs)(s.default, {
              href: "/admin/account",
              className:
                "flex min-w-0 items-center rounded-full border border-lien bg-white shadow-sm ".concat(
                  n
                    ? "h-10 max-w-28 gap-1.5 px-2"
                    : "h-10 max-w-44 gap-2 px-2.5 pr-3",
                  " transition hover:border-[color:var(--lien-primary-soft)] hover:bg-lien-soft",
                ),
              title: "ログインID・パスワードを変更",
              "aria-label": "".concat(t, "のアカウント設定を開く"),
              children: [
                (0, a.jsx)("span", {
                  className:
      ...
      function P(e) {
        ...
        let {
            ...
            storeIconUrl: i,
            backofficeRole: o,
            backofficeDisplayName: c,
          } = e,
          d = (0, r.usePathname)(),
          [m, w] = (0, v.useState)(""),
          [y, g] = (0, v.useState)(!1),
          [sidebarCollapsed, setSidebarCollapsed] = (0, v.useState)(!1),
          [k, P] = (0, v.useState)(!1),
          [A, _] = (0, v.useState)(""),
          E = (e) =>
            (!e.ownerOnly || "ADMIN" === o) &&
            (!e.staffOnly || "ADMIN" === o || "STAFF" === o),
          O = N.filter(E),
          I =
            "ADMIN" === o
              ? "/admin/settings"
          ...
          R = M.filter(E),
          V =
            /^\/admin\/coupon-issues\/[^/]+\/print$/.test(d) ||
            /^\/customers\/[^/]+\/coupons\/[^/]+\/print$/.test(d) ||
            /^\/customers\/[^/]+\/coupon\/print\/[^/]+$/.test(d) ||
            /^\/admin\/appointments\/[^/]+\/receipt$/.test(d);
        ((0, v.useEffect)(() => {
          let e = () => {
            var e;
            w(
          ...
          (0, v.useEffect)(() => {
            setSidebarCollapsed(
              window.localStorage.getItem("lien-sidebar-collapsed") === "1",
            );
          }, []),
          (0, v.useEffect)(() => {
            window.localStorage.setItem(
              "lien-sidebar-collapsed",
        ...
        let U =
          ...
          $ = R.filter((e) => {
            ...
            return (
              !t ||
              "".concat(e.label, " ").concat(e.hint).toLowerCase().includes(t)
            );
          });
        if (
          "/admin/login" === d ||
          d.startsWith("/admin/password-reset") ||
          C.some((e) => d.startsWith(e)) ||
          V
        )
          return (0, a.jsx)("div", {
            className: "admin-app-shell admin-mobile-workspace-v38 admin-staff-unified-v48 min-h-screen overflow-x-hidden bg-lien text-lien-ink",
            children: l,
          });
        let D = (0, a.jsxs)("div", {
          className:
              ...
              children: (0, a.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, a.jsx)("button", {
                    ...
                    onClick: () => g(!1),
                    "aria-label": "メニューを閉じる",
                    children: (0, a.jsx)(h.Z, { className: "h-5 w-5" }),
                  }),
                ],
              }),
            }),
              ...
              children: [
                O.map((e) => {
                  ...
                  return (0, a.jsxs)(
                    s.default,
                    {
                      ...
                      className:
                        "lien-nav-item group flex min-h-11 items-center gap-3 rounded-full px-3 text-sm font-semibold transition ".concat(
                          r
                      ...
                      children: [
                        (0, a.jsx)(t, {
                          className: "h-4 w-4 shrink-0 ".concat(
                            r
                              ? "text-white"
                              : "text-[#a79b91] group-hover:text-[color:var(--lien-primary)]",
                          ),
                        }),
                        (0, a.jsx)("span", {
                          className: "truncate",
                ...
                (0, a.jsx)("form", {
                  ...
                  children: (0, a.jsxs)("button", {
                    ...
                    children: [
                      (0, a.jsx)(u.Z, { className: "h-4 w-4 shrink-0" }),
                      (0, a.jsx)("span", { children: "ログアウト" }),
                    ],
                  }),
                }),
              ],
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            (0, a.jsx)("aside", {
              className: `admin-desktop-sidebar fixed inset-y-0 left-0 z-30 hidden w-64 border-r border-lien bg-white/90 shadow-lien-sm transition-transform duration-200 md:block ${sidebarCollapsed ? "-translate-x-full" : "translate-x-0"}`,
              children: D,
            }),
            (0, a.jsx)("button", {
              type: "button",
            ...
            (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsxs)("header", {
                  className:
                    "admin-shell-header sticky top-0 z-40 border-b border-lien bg-[#fffdf9]/92 backdrop-blur-xl",
                  children: [
                    (0, a.jsxs)("div", {
                      className:
                        "admin-mobile-header flex h-14 items-center justify-between px-4 md:hidden",
                      children: [
                        (0, a.jsxs)(s.default, {
                          href: "/admin/customers",
                          className:
                          ...
                          children: [
                            (0, a.jsx)(L, { imageUrl: i, compact: !0 }),
                            (0, a.jsx)("span", {
                              className: "truncate",
                              children: "Salon de Lien",
                            }),
                        ...
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            (0, a.jsx)("div", { className: "ca-header-store-mount", "data-ca-header-actions": "" }),
                            (0, a.jsx)("button", {
                              type: "button",
                              className: "lien-icon-button text-lien-ink",
                              onClick: () => g(!0),
                              "aria-label": "メニューを開く",
                              children: (0, a.jsx)(x, { className: "h-5 w-5" }),
                            }),
                          ],
                        }),
                      ],
                    ...
                    (0, a.jsxs)("div", {
                      className:
                        "admin-desktop-header hidden min-h-16 min-w-0 items-center gap-3 px-5 py-3 md:flex lg:px-8",
                      children: [
                        (0, a.jsxs)("div", {
                          className: "min-w-0",
                          children: [
                ...
                (0, a.jsx)("main", {
                  className:
                    "admin-main-content min-w-0 overflow-x-hidden px-4 py-5 sm:px-6 lg:px-8",
                  children: l,
                }),
              ],
            }),
    ...
    3284: function (e, t, n) {
      ...
      let a = (0, n(5480).Z)("calendar-days", [
  ...
  function (e) {
    (e.O(0, [2461, 3717, 5878, 2971, 2117, 1744], function () {
      return e((e.s = 4235));
    }),
      (_N_E = e.O()));
  },
...
;(()=>{
  /* tenant-runtime-v110: helpers start only after hydration.  Catalog markup remains
     exclusively React-owned so product/menu tab transitions stay safe. */
  let started=false
  function appendRuntime(src,name){
  ...
  function loadAdminRuntime(){
    ...
    started=true
    appendRuntime('/tenant-setup-client.js?v=20260817-267','admin-route-lifecycle')
    appendRuntime('/commercial-admin-v136.js?v=20260817-267','commercial-admin-shell')
  }
  const schedule=()=>window.requestAnimationFrame(loadAdminRuntime)
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',schedule,{once:true})
  else schedule()
})()

/* tenant-runtime-v117-commercial-catalog-store-profile */

/* tenant-runtime-v118-store-menu-delegated-click */

/* tenant-runtime-v119-stable-store-menu-links */

/* admin-header-settings-v127 */

/* admin-header-settings-v128 */

/* admin-header-settings-v129 */

/* admin-header-settings-v130 */

/* commercial-sidebar-v135 */

/* admin-theme-and-modal-v153 */
