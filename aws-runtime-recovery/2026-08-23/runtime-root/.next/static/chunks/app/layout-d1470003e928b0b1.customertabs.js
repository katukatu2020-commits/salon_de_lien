  ...
  [3185],
  {
    ...
    16: function (e, t, n) {
      ...
      let N = [
          ...
          { href: "/admin/products?section=menus", label: "メニュー・商品棚・集計", icon: c },
          {
      ...
      function P(e) {
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            (0, a.jsx)("aside", {
              className:
                "fixed inset-y-0 left-0 z-30 hidden w-64 border-r border-lien bg-white/90 shadow-lien-sm md:block",
              children: D,
            }),
            y
              ? (0, a.jsxs)("div", {
