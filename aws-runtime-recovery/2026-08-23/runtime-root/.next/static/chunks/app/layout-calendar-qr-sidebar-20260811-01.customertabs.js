        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            ...
            (0, a.jsx)("button", {
              ...
              className: `fixed top-3 z-50 hidden h-10 items-center justify-center rounded-full border border-lien bg-white px-3 text-xs font-semibold text-lien-primary shadow-sm transition-all hover:bg-lien-soft md:inline-flex ${sidebarCollapsed ? "left-3" : "left-[12.5rem]"}`,
              style: { left: sidebarCollapsed ? "0.75rem" : "12.5rem" },
                    ...
                    (0, a.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            (0, a.jsx)(z, { displayName: c, compact: !0 }),
                            (0, a.jsx)(s.default, {
                              href: I,
                              onClick: () => w("settings"),
                              ...
                              "aria-label": "設定を開く",
                              title: "設定",
                              children: (0, a.jsx)(p, { className: "h-4 w-4" }),
                            }),
                            (0, a.jsx)("button", {
                              type: "button",
                    ...
                    (0, a.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, a.jsxs)("button", {
                          ...
                          children: [
                            (0, a.jsx)(b, { className: "h-4 w-4" }),
                            "Ctrl K",
                          ],
                        }),
                        (0, a.jsx)(z, { displayName: c }),
                        (0, a.jsx)(s.default, {
                          href: I,
                          onClick: () => w("settings"),
