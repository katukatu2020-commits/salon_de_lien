    ...
    4548: function (e, t, n) {
      ...
      function k(e) {
        let {
          ...
          E = (0, l.useRef)(null),
          _ = (0, l.useRef)(0),
          [z, Z] = (0, l.useState)(960),[__businessSchedule,__setBusinessSchedule]=(0,l.useState)({openMinutes:600,closeMinutes:1140,closedWeekdays:[1]}),__businessOpen=Number(__businessSchedule.openMinutes)||600,__businessClose=Number(__businessSchedule.closeMinutes)||1140,__businessDuration=Math.max(60,__businessClose-__businessOpen),__shiftWeekday=new Date(t+"T00:00:00Z").getUTCDay(),[__shiftHydrated,__setShiftHydrated]=(0,l.useState)(false),__businessScheduleBridge=typeof window!=="undefined"&&(window.__lienSetBusinessSchedule=__setBusinessSchedule),
          R = z < 420 ? 92 : z < 760 ? 124 : 176,
          L = Math.max(1, z - R),
          O = L / __businessDuration,
          q = L < 440 ? 60 : 30,
          F = (0, l.useMemo)(
            () => Array.from({ length: __businessDuration / q }, (e, t) => __businessOpen + t * q),
            [q,__businessOpen,__businessDuration],
          ),
          U = (0, l.useMemo)(() => {
            let e = L < 260 ? 180 : L < 520 ? 120 : 60,
              t = Array.from(
                { length: Math.floor(__businessDuration / e) + 1 },
                (t, n) => __businessOpen + n * e,
              );
            return (__businessClose !== t.at(-1) && t.push(__businessClose), t);
          }, [L,__businessOpen,__businessClose,__businessDuration]);
        ((0, l.useEffect)(() => {
          ((A.current = c), M(c));
        }, [c]),
          (0, l.useEffect)(() => {
              ...
              F.map((e) => {
                let t = e + q,
                  n = m.reduce(
                    (n, r) =>
                      n +
                      (!r.isVirtualFree && r.key !== "free" && r.name !== "フリー" && !(Array.isArray(r.closedWeekdays) && r.closedWeekdays.includes(__shiftWeekday)) && r.workStartMinutes < t && e < r.workEndMinutes
                        ? Math.max(1, Number(r.maxConcurrentAppointments) || 1)
                        : 0),
                    0,
                  ),
                  r = k.filter((n) => {
                ...
                let a = Math.max(0, n - r),
                  o = Number.isInteger(capacityOverrides[e]) && capacityOverrides[e] >= 0 ? capacityOverrides[e] : null;
                return {
                  slotStart: e,
                  capacity: n,
                  booked: r,
        ...
        } /* commercial-reward-notifications-capacity-v44-admin-capacity */
        function X(e, t) {
          M((n) => {
        ...
        async function Q(e, n) {
          ...
          if ("ArrowLeft" === n.key)
            ...
            n.shiftKey
              ? (i = Math.min(__businessClose - a, i + 10))
              : (a = Math.min(__businessClose - i, a + 15));
        ...
        if(!__shiftHydrated)return (0,r.jsxs)("div",{className:"grid min-h-[520px] place-items-center rounded-2xl border border-[color:var(--lien-border)] bg-white shadow-sm",role:"status","aria-live":"polite","aria-busy":"true",children:[(0,r.jsx)("span",{className:"h-8 w-8 animate-spin rounded-full border-2 border-[#ead8d1] border-t-[color:var(--lien-primary)]","aria-hidden":"true"}),(0,r.jsx)("span",{className:"sr-only",children:"シフト表を読み込んでいます"})]});return (0, r.jsxs)("div", {
          ...
          children: [
                ...
                (0, r.jsxs)("div", {
                  children: [
                    ...
                    (0, r.jsxs)("div", {
                        ...
                        children: [
                          r.jsx("a", {
                            href: (() => { const day = new Date(new Date(t + "T00:00:00Z").getTime() - 864e5).toISOString().slice(0, 10); return "/admin/appointments?month=" + day.slice(0, 7) + "&date=" + day + "#staff-schedule" })(),
                            ...
                            "aria-hidden": "true",
                            children: r.jsx("path", { d: "m15 18-6-6 6-6" }),
                          }),
                          }),
                          r.jsx("h2", {
                          ...
                          r.jsx("a", {
                            ...
                            strokeLinejoin: "round",
                            "aria-hidden": "true",
                            children: r.jsx("path", { d: "m9 18 6-6-6-6" }),
                          }),
                          }),
                        ],
                      }),
                    (0, r.jsx)("p", {
                      ...
                      children:
                        "予約をドラッグして移動、右端を引いて施術時間を変更できます。施術時間は10分単位で保存されます。",
                    }),
                  ],
                }),
                (0, r.jsxs)("div", {
            ...
            (0, r.jsx)("div", {
              ref: E,
              className:
                "isolate w-full overflow-hidden rounded-2xl border border-[color:var(--lien-border)] bg-white shadow-sm",
                ...
                children: [
                  (0, r.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, r.jsx)("div", {
                        className:
                          "relative h-12 border-b border-[color:var(--lien-border)] bg-white/70",
                        children: U.map((e, t) =>
                          (0, r.jsx)(
                            "span",
                            {
                              className:
                                "absolute top-3.5 whitespace-nowrap text-[10px] font-semibold tabular-nums text-[color:var(--lien-ink)] sm:text-xs ".concat(
                                  0 === t
                                    ? ""
                                    : t === U.length - 1
                                      ? "-translate-x-full"
                      ...
                      (0, r.jsxs)("div", {
                        children: [
                          ...
                          (0, r.jsx)("div", {
                            className:
                              "grid h-9 border-t border-[color:var(--lien-border)]",
                            style: {
                              gridTemplateColumns: "repeat(".concat(
                                V.length,
                                ", minmax(0, 1fr))",
                          ...
                          (0, r.jsxs)("div", {
                            ...
                            children: [
                              (0, r.jsx)("div", {
                                ...
                                style: {
                                  width:
                                    Math.max(0, e.workStartMinutes - __businessOpen) * O,
                                },
                              }),
                              (0, r.jsx)("div", {
                                className:
                                ...
                                style: {
                                  width:
                                    Math.max(0, __businessClose - e.workEndMinutes) * O,
                                },
                              }),
                              F.map((t) =>
                                (0, r.jsx)(
                                  "span",
                                  {
                                    "aria-hidden": "true",
                                    className:
                                      "pointer-events-none absolute inset-y-0 border-l border-[#c7b6aa]",
                                    style: { left: (t - __businessOpen) * O },
                                  },
                                  "".concat(e.key, "-").concat(t),
                                ),
                              ),
                              f && null !== x && x >= __businessOpen && x <= __businessClose
                                ? (0, r.jsx)("span", {
                                    "aria-label": "現在時刻",
                                    className:
                                      "shift-now pointer-events-none absolute inset-y-0 z-20 w-0.5",
                                    style: { left: (x - __businessOpen) * O },
                                    ...
                                    children: [
                                      (0, r.jsxs)("span", {
                                        ...
                                        children: [
                                          (0, r.jsx)("span", {
                                            className:
                                              "grid h-5 min-w-5 place-items-center rounded px-1 text-[9px] font-bold ".concat(
                                                c.className,
                                              ),
                                            title: c.label,
                                            children: c.symbol,
                                          ...
                                          ...menuCategory(e.menu)
                                            ...
                                            .map((e) =>
                                              (0, r.jsx)(
                                                ...
                                                {
                                                  className:
                                                    "ml-1 grid h-5 min-w-5 place-items-center rounded border border-black/10 bg-white/80 px-1 text-[9px] font-bold text-[color:var(--lien-ink)]",
                                                  children: e,
                                                },
                                                e,
                                              ),
