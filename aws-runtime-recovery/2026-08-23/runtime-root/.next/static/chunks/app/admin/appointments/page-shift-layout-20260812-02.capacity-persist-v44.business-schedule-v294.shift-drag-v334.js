    ...
    4548: function (e, t, n) {
      ...
      function k(e) {
        ...
        function B(e) {
          ...
          if (!n.moved) {
            n.moved = !0;
            window.dispatchEvent(new CustomEvent("lien:shift-drag-start", { detail: { appointmentId: l.id, mode: n.mode, customerName: l.customerName || l.customerRealName || "予約", staffName: l.staffName, startMinutes: g(l.scheduledAt), durationMinutes: l.durationMinutes, clientX: e.clientX, clientY: e.clientY, sourceElement: n.sourceElement } }));
          }
