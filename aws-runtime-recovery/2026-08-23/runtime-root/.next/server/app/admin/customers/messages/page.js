(() => {
    ...
    (e.modules = {
      ...
      95239: (e, s, t) => {
        ...
        let d = (0, c.Z)("message-square", [["path", { d: "M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4z", key: "chat" }]]),
          h = "force-dynamic"; /* review-chat-free-navigation-v45-admin-chat */
        async function y({ searchParams: e }) {
          ...
          let t = await o._.$queryRawUnsafe('SELECT t.*, c."name" AS "customerName", (SELECT COUNT(*)::int FROM "ChatMessage" m WHERE m."threadId"=t."id" AND m."senderType"=\'customer\' AND (t."staffLastReadAt" IS NULL OR m."createdAt">t."staffLastReadAt")) AS "unreadCount", (SELECT m."body" FROM "ChatMessage" m WHERE m."threadId"=t."id" ORDER BY m."createdAt" DESC LIMIT 1) AS "latestBody", (SELECT m."createdAt" FROM "ChatMessage" m WHERE m."threadId"=t."id" ORDER BY m."createdAt" DESC LIMIT 1) AS "latestAt" FROM "ChatThread" t JOIN "Customer" c ON c."id"=t."customerId" WHERE t."organizationId"=$1 AND c."deletedAt" IS NULL AND c."storeHiddenAt" IS NULL ORDER BY /* store-hidden-customer-consistency-v360 */ t."updatedAt" DESC', s.organizationId),
            m = e?.threadId ? t.find((s) => s.id === e.threadId) : e?.customerId ? t.find((s) => s.customerId === e.customerId) : null /* admin-chat-explicit-selection-v38 */,
            u = m ? await o._.$queryRawUnsafe('SELECT * FROM "ChatMessage" WHERE "threadId"=$1 ORDER BY "createdAt" ASC LIMIT 300', m.id) : [];
          let q = !m && e?.customerId ? await o._.customer.findFirst({ where: { id: e.customerId, organizationId: s.organizationId, deletedAt: null, storeHiddenAt: null /* store-hidden-customer-consistency-v360 */ }, select: { id: true, name: true } }) : null;
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [
              ...
              (0, r.jsxs)("div", {
                className: "admin-chat-layout grid min-h-[620px] gap-4 lg:grid-cols-[19rem_minmax(0,1fr)]",
                ...
                children: [
                  ...
                  r.jsx(i.IP, {
                    className: "admin-chat-conversation flex min-h-[620px] flex-col",
                    style: { minHeight: "620px" },
                    children: m ? (0, r.jsxs)(r.Fragment, { children: [r.jsx("a",{href:"/admin/customers/messages/chat",className:"admin-chat-mobile-back",children:"← トーク一覧"}),
      ...
      995239: (e, s, t) => {
        ...
        async function j({ searchParams: e }) {
          let s = await (0, g.Os)(["ADMIN","STAFF"]);
          if (!s.organizationId) return null;
          let [t, l, b, R, U, V] = await Promise.all([
            ...
            f._.customer.findMany({
              where: { organizationId: s.organizationId, deletedAt: null, storeHiddenAt: null /* store-hidden-customer-consistency-v360 */ },
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [
              ...
              e?.points === "1"
                ...
                : null,(0,r.jsxs)("details",{className:"rounded-[18px] border border-lien bg-white shadow-lien-sm",children:[r.jsx("summary",{className:"cursor-pointer list-none px-5 py-4 font-semibold text-lien-ink",children:"ポイント管理"}),r.jsx("div",{className:"border-t border-lien px-5 py-4",children:(0,r.jsxs)("div",{className:"flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between",children:[r.jsx("p",{className:"text-sm text-lien-muted",children:"保有ポイント、付与・利用履歴、ポイント設定を確認します。"}),r.jsx(n.default,{href:"/admin/customers/messages?points=1&pointPage=1#point-management-dialog",className:"inline-flex min-h-10 items-center justify-center rounded-[12px] bg-[color:var(--lien-primary)] px-4 text-sm font-semibold text-white",children:"ポイント管理を開く"})]})})]}),
              r.jsx(p.mr, {
      ...
      47015: (e, s, t) => {
        ...
        function o({ active: e }) {
          let s = [
            ...
            {
              key:"points",href:"/admin/customers/messages/chat",label:"チャット",
              icon: i.Z,
            },
            {
              key: "messages",
          ...
          let s = await n._.appUser.findFirst({
            where: {
              ...
              customer: {
                ...
                organizationId: e.organizationId,
                deletedAt: null,
                storeHiddenAt: null, /* store-hidden-customer-consistency-v360 */
              },
            },
            select: {
              id: !0,
  ...
  s.C(e);
  var t = (e) => s((s.s = e)),
    r = s.X(0, [9380,4108,2159,3914,7708,5433,1425,9845,2564,7401,3950,7295,2241,3491], () => t(9296));
  module.exports = r;
})();
