        ...
        let t = await m(),
          ...
          [b, j] = await Promise.all([
            ...
            l._.customer.findFirst({
              where: { id: r, organizationId: t, deletedAt: null, storeHiddenAt: null /* store-hidden-customer-consistency-v360 */ },
              select: { id: !0 },
            }),
          ]);
        ...
        let t = await m(),
          ...
          c = await l._.productReview.findFirst({
            where: {
              id: a,
              productProposal: {
                customer: { organizationId: t, deletedAt: null, storeHiddenAt: null /* store-hidden-customer-consistency-v360 */ },
      ...
      async function m(e, t) {
        let [a, n] = await Promise.all([
          ...
          r._.customer.findMany({
            where: { deletedAt: null, storeHiddenAt: null, /* store-hidden-customer-consistency-v360 */ ...(t ? { organizationId: t } : {}) },
            orderBy: { name: "asc" },
            take: 300,
        ...
        let x = { from: c, to: u },
          ...
          N = g.map((e) => {
            ...
            let i = e.proposals.flatMap((e) =>
              ...
              o = i.map((e) => ({
                ...e,
                comment: m ? e.comment : i.length >= Math.max(3, s) ? e.comment : "", /* review-chat-free-navigation-v45-reviews-page */
              })),
