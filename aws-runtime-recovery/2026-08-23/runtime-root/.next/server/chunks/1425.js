    ...
    50141: (e, t, n) => {
      ...
      function k({ imageUrl: e, compact: t = !1 }) {
        return r.jsx("span", {
          ...
          children: r.jsx("span", { className: "sr-only", children: "Salon customer servitomer service" }),
        });
      }
      function B(){let[e,t]=(0,b.useState)(0);(0,b.useEffect)(()=>{let e=!1;async function n(){try{let n=await fetch("/api/lien-staff-notifications?history=1",{cache:"no-store"}),r=await n.json();e||t(Number(r.count)||0)}catch{}}n();let r=setInterval(n,3e4);return()=>{e=!0,clearInterval(r)}},[]);return(0,r.jsxs)(a.default,{href:"/admin/notifications",className:"relative lien-button-secondary h-10 shrink-0 px-3 text-xs",title:"お知らせ",children:[r.jsx("span",{children:"お知らせ"}),e>0?r.jsx("span",{className:"absolute -right-1 -top-1 grid min-h-5 min-w-5 place-items-center rounded-full bg-red-600 px-1 text-[10px] font-bold text-white",children:e>99?"99+":e}):null]})} function _({ displayName: e, compact: t = !1 }) {
        return e
          ? (0, r.jsxs)(a.default, {
              href: "/admin/account",
                    ...
                    (0, r.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, r.jsxs)("div", {
                          ...
                          children: [
                            (0, r.jsx)("div", { className: "ca-header-store-mount", "data-ca-header-actions": "" }),
                            r.jsx("button", {
                              type: "button",
