...
async function customerMenuPage(res, session) {
  const data = await customerAppData(session)
  const rows = [['bell','SMS予約通知','/u/sms-settings'],['user','会員情報の確認・変更','/u/profile'],['clock','来店履歴','/u/history'],['points','ポイント','/u/points'],['ticket','クーポン','/u/coupons'],['stamp','スタンプカード','/u/stamps'],['crown','アイテムランキング','/u/catalog'],['scissors','ヘアスタイル','/u/community'],['heart','商品アンケート','/u/reviews'],['mail','チャット相談','/u/chat'],['news','お知らせ','/u/news']]
