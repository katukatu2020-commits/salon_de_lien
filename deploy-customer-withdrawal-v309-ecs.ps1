...
$containerName = 'Web'
$image = '009293460979.dkr.ecr.ap-northeast-1.amazonaws.com/salon-de-lien-staging-app:customer-withdrawal-v309-20260820'
$tempRoot = [System.IO.Path]::GetFullPath([System.IO.Path]::GetTempPath())
$taskDefinitionPath = [System.IO.Path]::GetFullPath((Join-Path $tempRoot ("customer-withdrawal-v309-task-definition-" + [guid]::NewGuid().ToString('N') + '.json')))
