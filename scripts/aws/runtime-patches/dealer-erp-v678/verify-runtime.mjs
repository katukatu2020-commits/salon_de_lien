...
assert.doesNotMatch(read('dealer-erp-v678.js'), /importPayments|csv-parse\/sync/)
assert.doesNotMatch(read('dealer-erp-v678-client.js'), /payment-import|payment-template/)
