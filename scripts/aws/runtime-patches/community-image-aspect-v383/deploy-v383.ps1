...
$tag = "community-image-aspect-v383"
...
if ($imageExists) {
  ...
  docker build --pull=false --build-arg BASE_IMAGE="$accountId.dkr.ecr.$region.amazonaws.com/${repository}:shift-day-navigation-v382" -f "scripts/aws/runtime-patches/community-image-aspect-v383/Dockerfile" -t $image .
...
$taskFile = Join-Path $env:TEMP "salon-v383-task-definition.json"
...
$invalidation = aws cloudfront create-invalidation --distribution-id $distributionId --paths "/admin/community*" "/u/community*" "/_next/static/chunks/6012-community-aspect-v383.js" "/_next/static/chunks/app/u/(account)/layout-community-aspect-v383.js" "/customer-community-mobile-v383.js" --query "Invalidation.Id" --output text
