param(
  ...
  [string]$SourceTaskDefinition = 'salon-de-lien-staging-web:332',
  [string]$Image = '009293460979.dkr.ecr.ap-northeast-1.amazonaws.com/salon-de-lien-staging-app:shift-drag-capture-v333'
)
