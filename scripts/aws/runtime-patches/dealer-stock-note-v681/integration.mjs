...
const cases=new URL('./stock-notes-cases.mjs',import.meta.url).href
const source=parent.replace(anchor,`  await (await import(${JSON.stringify(cases)})).verify({action,denied,get,sql,a,b,staff})\n${anchor}`)
