...
const clientPath =
  ...
  new URL("./content-edit-delete-client-v558.js", import.meta.url);
...
assert.match(source, /window\.__lienStyleCommunityControlsV558 = true/);
...
assert.match(source, /dataset\.lienCustomerCommentMenu = "v558"/);
assert.match(
  detailEnhancer,
