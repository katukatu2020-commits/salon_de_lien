...
const clientSource = path.join(patchRoot, "content-edit-delete-client-v558.js");
const clientTarget = path.join(
  root,
  "public",
  "content-edit-delete-client-v558.js",
);
const oldClientPath = "/content-edit-delete-client-v557.js";
const newClientPath = "/content-edit-delete-client-v558.js";
const oldBootstrap = '"data-lien-community-bootstrap": "v557"';
const newBootstrap = '"data-lien-community-bootstrap": "v558"';
const staffRuntimePath = path.join(root, "admin-staff-experience-v276.js");
const serverPath = path.join(root, "server.js");
const marker = "deletion-confirmation-checkbox-v558";
const pageFiles = [
...
const previousReady = `      if (url.pathname === '/api/health/ready') res.setHeader('X-Lien-Customer-Comment-Actions', 'v557') /* customer-community-comment-menu-v557 */`;
server = replaceExactly(
  server,
  previousReady,
  `${previousReady}\n      if (url.pathname === '/api/health/ready') res.setHeader('X-Lien-Deletion-Confirmation', 'v558') /* ${marker} */`,
  1,
  "readiness marker",
);
server += `\n/* ${marker} */\n`;
