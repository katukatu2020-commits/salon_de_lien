(() => {
  ...
  if (window.__lienStyleCommunityControlsV558) return;
  window.__lienStyleCommunityControlsV558 = true;
  ...
  function addStyles() {
    if (document.getElementById("lien-style-community-controls-v558-style"))
      return;
    const style = document.createElement("style");
    style.id = "lien-style-community-controls-v558-style";
    style.textContent = `
      ...
      .lien-comment-menu-shell{position:relative;display:block;margin-left:auto;flex:0 0 auto;align-self:flex-start}
  ...
  function buildCustomerCommentMenu(comment, onEdit, onDelete) {
    ...
    shell.dataset.lienCustomerCommentMenu = "v558";
  ...
  async function enhanceCommunityDetail() {
    ...
    if (!match || window.__lienCommunityDetailLoadingV558 === match[2]) return;
    ...
    if (
      document.body.dataset.lienCommunityOwnerEnhancedV558 === match[2] &&
      initialContent.dataset.lienCommentSignatureV558 === initialSignature
    )
      return;
    const postId = decodeURIComponent(match[2]);
    let payload;
    window.__lienCommunityDetailLoadingV558 = match[2];
    try {
      payload = await requestJson(
      ...
      if (window.__lienCommunityDetailLoadingV558 === match[2])
        window.__lienCommunityDetailLoadingV558 = "";
    }
    ...
    document.body.dataset.lienCommunityOwnerEnhancedV558 = postId;
      ...
      const editComment = () =>
        openDialog({
          ...
          onConfirm: async (body) => {
            ...
            content.dataset.lienCommentSignatureV558 =
    ...
    content.dataset.lienCommentSignatureV558 = visibleCommentSignature(content);
  }
  ...
  window.__lienStyleCommunityRepairV558 = () => {
    activateControls();
    scheduleAfterRouteChange();
  };
  activateControls();
