...
$tag = 'customer-cancellation-resilience-v380'
...
docker build --pull=false -f scripts/aws/runtime-patches/customer-cancellation-resilience-v380/Dockerfile -t $image .
...
$taskFile = Join-Path $env:TEMP 'salon-de-lien-task-v380.json'
