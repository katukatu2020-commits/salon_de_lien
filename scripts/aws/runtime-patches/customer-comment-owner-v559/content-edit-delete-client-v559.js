(() => {
  ...
  if (window.__lienStyleCommunityControlsV559) return;
  ...
  function addStyles() {
    if (document.getElementById("lien-style-community-controls-v559-style"))
      return;
    const style = document.createElement("style");
    style.id = "lien-style-community-controls-v559-style";
    style.textContent = `
  ...
  function buildCustomerCommentMenu(comment, onEdit, onDelete) {
    ...
    shell.dataset.lienCustomerCommentMenu = "v559";
  ...
  async function enhanceCommunityDetail() {
    ...
    if (!match || window.__lienCommunityDetailLoadingV559 === match[2]) return;
    ...
    if (
      document.body.dataset.lienCommunityOwnerEnhancedV559 === match[2] &&
      initialContent.dataset.lienCommentSignatureV559 === initialSignature
    )
      return;
    const postId = decodeURIComponent(match[2]);
    let payload;
    window.__lienCommunityDetailLoadingV559 = match[2];
    try {
      payload = await requestJson(
      ...
      if (window.__lienCommunityDetailLoadingV559 === match[2])
        window.__lienCommunityDetailLoadingV559 = "";
    }
    ...
    document.body.dataset.lienCommunityOwnerEnhancedV559 = postId;
      ...
      const editComment = () =>
        openDialog({
          ...
          onConfirm: async (body) => {
            ...
            content.dataset.lienCommentSignatureV559 =
  ...
  window.__lienStyleCommunityRepairV559 = () => {
    activateControls();
    scheduleAfterRouteChange();
  };
  activateControls();
