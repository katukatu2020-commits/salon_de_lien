...
const clientPath =
  ...
  new URL("./content-edit-delete-client-v559.js", import.meta.url);
...
assert.match(source, /window\.__lienStyleCommunityControlsV559 = true/);
...
assert.match(source, /dataset\.lienCustomerCommentMenu = "v559"/);
assert.match(
  detailEnhancer,
