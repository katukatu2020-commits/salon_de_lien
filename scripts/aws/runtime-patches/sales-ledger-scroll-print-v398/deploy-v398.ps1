...
$Tag = 'sales-ledger-scroll-print-v398'
...
if ($LASTEXITCODE -ne 0) {
  ...
  $DockerConfig = Join-Path $env:TEMP ("salon-ecr-v398-" + [Guid]::NewGuid().ToString('N'))
...
docker build -f scripts/aws/runtime-patches/sales-ledger-scroll-print-v398/Dockerfile -t $Image .
...
$TaskFile = Join-Path $env:TEMP 'salon-de-lien-task-v398.json'
[System.IO.File]::WriteAllText(
  $TaskFile,
