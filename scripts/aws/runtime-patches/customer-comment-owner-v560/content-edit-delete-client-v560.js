(() => {
  ...
  if (window.__lienStyleCommunityControlsV560) return;
  window.__lienStyleCommunityControlsV560 = true;
  ...
  function addStyles() {
    if (document.getElementById("lien-style-community-controls-v560-style"))
      return;
    const style = document.createElement("style");
    style.id = "lien-style-community-controls-v560-style";
    style.textContent = `
  ...
  function buildCustomerCommentMenu(comment, onEdit, onDelete) {
    ...
    shell.dataset.lienCustomerCommentMenu = "v560";
  ...
  async function enhanceCommunityDetail() {
    ...
    if (!match || window.__lienCommunityDetailLoadingV560 === match[2]) return;
    ...
    if (
      document.body.dataset.lienCommunityOwnerEnhancedV560 === match[2] &&
      initialContent.dataset.lienCommentSignatureV560 === initialSignature
    )
      return;
    const postId = decodeURIComponent(match[2]);
    let payload;
    window.__lienCommunityDetailLoadingV560 = match[2];
    try {
      payload = await requestJson(
      ...
      if (window.__lienCommunityDetailLoadingV560 === match[2])
        window.__lienCommunityDetailLoadingV560 = "";
    }
    ...
    document.body.dataset.lienCommunityOwnerEnhancedV560 = postId;
      ...
      const editComment = () =>
        openDialog({
          ...
          onConfirm: async (body) => {
            ...
            content.dataset.lienCommentSignatureV560 =
    ...
    content.dataset.lienCommentSignatureV560 = visibleCommentSignature(content);
  }
  ...
  window.__lienStyleCommunityRepairV560 = () => {
    activateControls();
    scheduleAfterRouteChange();
  };
  activateControls();
