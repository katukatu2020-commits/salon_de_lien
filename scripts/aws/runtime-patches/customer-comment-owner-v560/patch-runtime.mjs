...
const clientSource = path.join(patchRoot, "content-edit-delete-client-v560.js");
const clientTarget = path.join(
  root,
  "public",
  "content-edit-delete-client-v560.js",
);
const oldClientPath = "/content-edit-delete-client-v559.js";
const newClientPath = "/content-edit-delete-client-v560.js";
const oldBootstrap = '"data-lien-community-bootstrap": "v559"';
const newBootstrap = '"data-lien-community-bootstrap": "v560"';
const staffRuntimePath = path.join(root, "admin-staff-experience-v276.js");
const serverPath = path.join(root, "server.js");
const marker = "customer-comment-owner-v560";
const pageFiles = [
...
const previousReady = `      if (url.pathname === '/api/health/ready') res.setHeader('X-Lien-Customer-Comment-Ownership', 'v559') /* customer-comment-owner-v559 */`;
server = replaceExactly(
  server,
  previousReady,
  `${previousReady}\n      if (url.pathname === '/api/health/ready') res.setHeader('X-Lien-Customer-Comment-Layout', 'v560') /* ${marker} */`,
  1,
  "readiness marker",
);
server += `\n/* ${marker} */\n`;
