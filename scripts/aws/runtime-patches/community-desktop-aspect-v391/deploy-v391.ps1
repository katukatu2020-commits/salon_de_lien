...
$Tag = 'community-desktop-aspect-v391'
...
if ($LASTEXITCODE -ne 0) {
  ...
  $DockerConfig = Join-Path $env:TEMP ("salon-ecr-v391-" + [Guid]::NewGuid().ToString('N'))
...
docker build -f scripts/aws/runtime-patches/community-desktop-aspect-v391/Dockerfile -t $Image .
...
$TaskFile = Join-Path $env:TEMP 'salon-de-lien-task-v391.json'
[System.IO.File]::WriteAllText(
  $TaskFile,
