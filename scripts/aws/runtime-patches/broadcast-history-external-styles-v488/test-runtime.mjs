...
const marker = source.indexOf('"data-lien-broadcast-history": "v488"')
const detailsStart = source.lastIndexOf('(0, r.jsxs)("details", {', marker)
const summaryStart = source.indexOf('(0, r.jsxs)("summary", {', marker)
const contentStart = source.indexOf('id: "broadcast-history-content-v488"', summaryStart)
...
console.log('broadcast history v488 runtime tests passed')
