...
$tag = 'customer-community-mobile-shell-v378'
...
docker build --pull=false -f scripts/aws/runtime-patches/customer-community-mobile-shell-v378/Dockerfile -t $image .
...
$taskFile = Join-Path $env:TEMP 'salon-de-lien-task-v378.json'
