...
const marker = 'style-community-controls-v469'
const paths = {
...
for (const [label, file] of Object.entries({
  adminDetail: paths.adminDetail,
  customerDetail: paths.customerDetail,
  adminChat: paths.adminChat,
})) {
  let source = fs.readFileSync(file, 'utf8')
  source = replaceExactly(
    source,
    '/content-edit-delete-client-v466.js',
...
let adminList = fs.readFileSync(paths.adminList, 'utf8')
adminList = replaceExactly(
  adminList,
  'return(0,n.jsxs)("div",{className:"grid gap-6",children:[',
  'return(0,n.jsxs)("div",{className:"grid gap-6",children:[n.jsx("script",{src:"/content-edit-delete-client-v469.js"}),',
  'admin community list script injection',
)
fs.writeFileSync(paths.adminList, adminList)
