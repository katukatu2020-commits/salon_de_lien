...
$tag = 'backoffice-access-consistency-v379'
...
docker build --pull=false -f scripts/aws/runtime-patches/backoffice-access-consistency-v379/Dockerfile -t $image .
...
$taskFile = Join-Path $env:TEMP 'salon-de-lien-task-v379.json'
