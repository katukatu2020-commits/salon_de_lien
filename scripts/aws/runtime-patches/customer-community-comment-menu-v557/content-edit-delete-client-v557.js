(() => {
  ...
  if (window.__lienStyleCommunityControlsV557) return;
  window.__lienStyleCommunityControlsV557 = true;
  ...
  function addStyles() {
    if (document.getElementById("lien-style-community-controls-v557-style"))
      return;
    const style = document.createElement("style");
    style.id = "lien-style-community-controls-v557-style";
    style.textContent = `
  ...
  function openDialog({
    ...
    confirm.onclick = async () => {
      ...
      if (
        confirmationText &&
        confirmationInput.value.trim() !== confirmationText
      ) {
        dialog.querySelector("[data-dialog-error]").textContent =
          `「${confirmationText}」と入力してください。`;
        return;
      }
      ...
      try {
        ...
        confirm.disabled = confirmationText
          ? confirmationInput.value.trim() !== confirmationText
          : false;
      }
    };
  ...
  function buildCustomerCommentMenu(comment, onEdit, onDelete) {
    ...
    shell.dataset.lienCustomerCommentMenu = "v557";
  ...
  async function enhanceCommunityDetail() {
    ...
    if (!match || window.__lienCommunityDetailLoadingV557 === match[2]) return;
    ...
    if (
      document.body.dataset.lienCommunityOwnerEnhancedV557 === match[2] &&
      initialContent.dataset.lienCommentSignatureV557 === initialSignature
    )
      return;
    const postId = decodeURIComponent(match[2]);
    let payload;
    window.__lienCommunityDetailLoadingV557 = match[2];
    try {
      payload = await requestJson(
      ...
      if (window.__lienCommunityDetailLoadingV557 === match[2])
        window.__lienCommunityDetailLoadingV557 = "";
    }
    ...
    document.body.dataset.lienCommunityOwnerEnhancedV557 = postId;
      ...
      const editComment = () =>
        openDialog({
          ...
          onConfirm: async (body) => {
            ...
            content.dataset.lienCommentSignatureV557 =
  ...
  window.__lienStyleCommunityRepairV557 = () => {
    activateControls();
    scheduleAfterRouteChange();
  };
  activateControls();
