...
const clientSource = path.join(patchRoot, "content-edit-delete-client-v557.js");
const clientTarget = path.join(
  root,
  "public",
  "content-edit-delete-client-v557.js",
);
const oldClientPath = "/content-edit-delete-client-v509.js";
const newClientPath = "/content-edit-delete-client-v557.js";
const oldBootstrap = '"data-lien-community-bootstrap": "v509"';
const newBootstrap = '"data-lien-community-bootstrap": "v557"';
const staffRuntimePath = path.join(root, "admin-staff-experience-v276.js");
const serverPath = path.join(root, "server.js");
const marker = "customer-community-comment-menu-v557";
const pageFiles = [
...
const previousReady = `      if (url.pathname === '/api/health/ready') res.setHeader('X-Lien-Dealer-Auth-Mail-Content', 'v556') /* dealer-auth-postmark-html-v556 */`;
server = replaceExactly(
  server,
  previousReady,
  `${previousReady}\n      if (url.pathname === '/api/health/ready') res.setHeader('X-Lien-Customer-Comment-Actions', 'v557') /* ${marker} */`,
  1,
  "readiness marker",
);
server += `\n/* ${marker} */\n`;
