...
const headers = {
  ...
  'User-Agent': 'ORIMIA-shared-account-identity-v553-smoke/1.0',
}

const ready = await fetch(`${baseUrl}/api/health/ready?smoke=v553`, { headers })
...
const client = await fetch(`${baseUrl}/sales-ledger-v318.js?smoke=v553`, {
