...
$tag = 'customer-community-mobile-runtime-v377'
...
docker build --pull=false -f scripts/aws/runtime-patches/customer-community-mobile-runtime-v377/Dockerfile -t $image .
...
$taskFile = Join-Path $env:TEMP 'salon-de-lien-task-v377.json'
