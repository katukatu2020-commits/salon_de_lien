...
assert.match(server, /style-admin-controls-v618\.js\?v=625-post-controls3/)
...
assert.doesNotMatch(client, /void enhanceDetail\(\)/)
assert.match(client, /querySelectorAll\('\.orimia-style-detail-controls-v625'\)\.forEach/)
