...
$containerName = 'Web'
$image = '009293460979.dkr.ecr.ap-northeast-1.amazonaws.com/salon-de-lien-staging-app:role-scoped-registration-v304-20260820'
$tempRoot = [System.IO.Path]::GetFullPath([System.IO.Path]::GetTempPath())
$taskDefinitionPath = [System.IO.Path]::GetFullPath((Join-Path $tempRoot ("registration-task-definition-" + [guid]::NewGuid().ToString('N') + '.json')))
