...
if (!layoutFiles[0].includes('.customer-home-unified-v35')) throw new Error(`Customer layout is not versioned: ${layoutFiles[0]}`)
...
for (const cssFile of cssFiles) {
  if (!cssFile.includes('.customer-home-unified-v35')) throw new Error(`Stylesheet is not versioned: ${cssFile}`)
