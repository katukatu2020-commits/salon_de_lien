      ...
      84448: (e, t, r) => {
        ...
        function k({
          ...
          let h = (0, s.useRouter)(),
            ...
            D = (0, i.useRef)(null),
            I = (0, i.useRef)(0),
            [q, Z] = (0, i.useState)(960),
            _ = q < 420 ? 92 : q < 760 ? 124 : 176,
            z = Math.max(1, q - _),
            E = z / 540,
            U = z < 440 ? 60 : 30,
            F = (0, i.useMemo)(
              () => Array.from({ length: 540 / U }, (e, t) => 600 + t * U),
              [U],
            ),
            L = (0, i.useMemo)(() => {
                ...
                F.map((e) => {
                  let t = e + U,
                    r = d.reduce(
                      (r, n) =>
                        r +
                        (n.workStartMinutes < t && e < n.workEndMinutes
                          ? n.maxConcurrentAppointments
                          : 0),
                      0,
                    ),
                    n = v.filter((r) => {
                  ...
                  return {
                    ...
                    capacity: r,
                    booked: n,
                    remaining: Number.isInteger(Q[e]) && Q[e] >= 0 ? Q[e] : a,
                  };
                }),
              [v, U, F, d, Q],
            );
          ...
          function Y(t) {
            ...
            if ("resize" === r.mode) {
              let e = g(
                ...
                15,
                1140 - r.originStartMinutes,
              );
              G(i.id, { durationMinutes: e });
              return;
            }
            let l = g(r.originStartMinutes + s, 600, 1140 - i.durationMinutes),
              o = document
          ...
          async function K(t, r) {
            ...
            if ("ArrowLeft" === r.key)
              ...
              r.shiftKey
                ? (s = Math.min(1140 - a, s + 15))
                : (a = Math.min(1140 - s, a + 15));
                        ...
                        n.jsx("div", {
                          ...
                          children: L.map((e, t) =>
                            n.jsx(
                              "span",
                              {
                                className: `absolute top-3 whitespace-nowrap text-[10px] font-semibold tabular-nums text-[color:var(--lien-ink)] sm:text-xs ${0 === t ? "" : t === L.length - 1 ? "-translate-x-full" : "-translate-x-1/2"}`,
                                style: {
                                  left:
                                    0 === t
                                      ? 4
                            ...
                            n.jsx("div", {
                              ...
                              children: O.map((e) =>
                                n.jsx(
                                  "input",
                                  {
                                    className: `grid place-items-center border-r border-[color:var(--lien-border)] text-[9px] font-bold tabular-nums sm:text-[11px] ${0 === e.remaining ? "bg-[#f9e8e5] text-[#9d4038]" : "text-[#41684f]"}`,
                                    style: { width: U * E },
                            ...
                            (0, n.jsxs)("div", {
                              ...
                              children: [
                                n.jsx("div", {
                                  ...
                                  style: {
                                    width:
                                      Math.max(0, e.workStartMinutes - 600) * E,
                                  },
                                }),
                                n.jsx("div", {
                                  className:
                                  ...
                                  style: {
                                    width:
                                      Math.max(0, 1140 - e.workEndMinutes) * E,
                                  },
                                }),
                                F.map((t) =>
                                  n.jsx(
      ...
      54726: (e, t, r) => {
        ...
        async function P({ searchParams: e }) {
          ...
          let N =
            ...
            [q, Z, _, z, V] = await Promise.all([
              ...
              v._.customer.findMany({
                where: { organizationId: x.organizationId, deletedAt: null },
          ...
          let K = "history" === e?.tab,
            ...
            X = n.jsx("nav", {
              className:
                "flex w-full gap-2 rounded-2xl border border-[color:var(--lien-border)] bg-white p-2",
              "aria-label": "予約管理表示切替",
              children: [
                n.jsx(a.default, {
                  href: `/admin/appointments?month=${N}&date=${P ?? `${N}-01`}&view=shift`,
                  className: `flex-1 rounded-xl px-4 py-3 text-center text-sm font-semibold transition ${!K && "shift" === Y ? "bg-[color:var(--lien-primary)] text-white shadow-sm" : "text-[color:var(--lien-muted)] hover:bg-[color:var(--lien-surface-soft)]"}`,
                  children: "シフト表",
                }),
                n.jsx(a.default, {
                  href: `/admin/appointments?month=${N}&view=calendar`,
                  className: `flex-1 rounded-xl px-4 py-3 text-center text-sm font-semibold transition ${!K && "calendar" === Y ? "bg-[color:var(--lien-primary)] text-white shadow-sm" : "text-[color:var(--lien-muted)] hover:bg-[color:var(--lien-surface-soft)]"}`,
                  children: "予約カレンダー",
                }),
                n.jsx(a.default, {
                  href: `/admin/appointments?month=${N}&tab=history`,
                  className: `flex-1 rounded-xl px-4 py-3 text-center text-sm font-semibold transition ${K ? "bg-[color:var(--lien-primary)] text-white shadow-sm" : "text-[color:var(--lien-muted)] hover:bg-[color:var(--lien-surface-soft)]"}`,
                  children: "履歴",
                }),
              ],
            });
          if (K)
            return (0, n.jsxs)("div", {
              className: "grid w-full max-w-none gap-6",
              children: [
                n.jsx(b.mr, {
          ...
          return (0, n.jsxs)("div", {
            ...
            children: [
              n.jsx(b.mr, {
                ...
                title: "シフト表・予約カレンダー",
                description:
                  "Gmailへ届いた新着予約メールを自動で予約台帳へ反映し、当日の来店予定と月間の予約状況を確認します。",
                secondaryAction: n.jsx(a.default, {
                  href: "/admin/customers",
                  className: "lien-button-secondary px-4",
                  children: "顧客一覧へ戻る",
