    ...
    (e.modules = {
      ...
      48319: (e, t, a) => {
        ...
        function d({
          ...
          buttonClassName: c = "lien-button-primary",
        }) {
          ...
          if (e?.section === "menus") {
            ...
            return (0, s.jsxs)("div", {
              ...
              children: [
                ...
                (0, s.jsxs)("section", { className: "rounded-[24px] border border-lien bg-white p-5 shadow-lien-sm sm:p-6", children: [
                  s.jsx("p", { className: "text-xs font-semibold text-lien-primary", children: "メニュー台帳" }),
                  s.jsx("h1", { className: "mt-1 text-2xl font-semibold text-lien-ink", children: "現在の施術メニュー" }),
                  s.jsx("p", { className: "mt-2 text-sm leading-6 text-lien-muted", children: "かんざし公開ページを基準に、名称・カテゴリ・施術時間・税込価格を管理します。自動クーポンの対象メニューにも反映されます。" }),
                  (0, s.jsxs)("form", { action: U.createSalonMenuAction, className: "mt-6 grid gap-4 rounded-[20px] bg-lien-soft p-4 sm:grid-cols-2 lg:grid-cols-5", children: [
                    s.jsx("input", { name: "menuName", className: "lien-input lg:col-span-2", placeholder: "メニュー名", required: !0, maxLength: 140 }),
                    s.jsx("input", { name: "menuCategory", className: "lien-input", placeholder: "カテゴリ", required: !0, maxLength: 80 }),
                    s.jsx("input", { name: "menuDuration", className: "lien-input", type: "number", min: "1", max: "1440", placeholder: "施術時間（分）", required: !0 }),
                    s.jsx("input", { name: "menuPrice", className: "lien-input", type: "number", min: "0", max: "10000000", placeholder: "税込価格（円）", required: !0 }),
                    s.jsx("textarea", { name: "menuDescription", className: "lien-input min-h-20 resize-y py-3 sm:col-span-2 lg:col-span-4", placeholder: "説明（任意）", maxLength: 1200 }),
                    s.jsx("button", { type: "submit", className: "lien-button-primary min-h-12", children: "メニューを追加" }),
                  ] }),
                ] }),
                (0, s.jsxs)("section", { className: "overflow-hidden rounded-[22px] border border-lien bg-white shadow-lien-sm", children: [
                  (0, s.jsxs)("div", { className: "flex items-center justify-between border-b border-lien px-5 py-4", children: [s.jsx("h2", { className: "font-semibold text-lien-ink", children: "登録済みメニュー" }), (0, s.jsxs)("span", { className: "text-sm font-semibold text-lien-muted", children: [menus.length, "件"] })] }),
                  s.jsx("div", { className: "grid divide-y divide-lien", children: menus.map((menu) => (0, s.jsxs)("article", { className: "grid gap-2 px-5 py-4 sm:grid-cols-[1fr_auto] sm:items-center", children: [
                    (0, s.jsxs)("div", { children: [(0, s.jsxs)("div", { className: "flex flex-wrap items-center gap-2", children: [s.jsx("h3", { className: "font-semibold text-lien-ink", children: menu.name }), s.jsx("span", { className: "rounded-full bg-lien-soft px-2 py-1 text-[11px] font-semibold text-lien-muted", children: menu.source === "kanzashi" ? "かんざし確認" : "手動追加" })] }), (0, s.jsxs)("p", { className: "mt-1 text-xs text-lien-muted", children: [menu.category, "・", menu.durationMinutes, "分"] }), menu.description ? s.jsx("p", { className: "mt-1 text-sm leading-6 text-lien-muted", children: menu.description }) : null] }),
                    (0, s.jsxs)("p", { className: "text-lg font-semibold tabular-nums text-lien-ink", children: [Number(menu.priceYen).toLocaleString("ja-JP"), "円"] }),
                  ] }, menu.id)) }),
                ] }),
              ],
            });
          ...
          return (0, s.jsxs)("div", {
            ...
            children: [
              ...
              B > 0
                ? (0, s.jsxs)("section", {
                    className:
                      "flex flex-col gap-4 rounded-[22px] border border-[#e8a7a1] bg-[#fff3f1] p-4 shadow-[0_14px_34px_rgba(159,45,37,0.09)] sm:flex-row sm:items-center sm:justify-between sm:p-5",
                    role: "alert",
                    children: [
                      (0, s.jsxs)("div", {
                        ...
                        children: [
                          s.jsx("span", {
                            className:
                              "lien-sales-alert-lamp mt-0.5 h-9 w-9 shrink-0",
                            children: s.jsx(n, {
                              className: "h-5 w-5",
                              strokeWidth: 2.5,
                            }),
                          ...
                          (0, s.jsxs)("div", {
                            children: [
                              (0, s.jsxs)("p", {
                                className: "font-semibold text-[#80231d]",
                                children: [
                                  "販売フォローが必要な商品が ",
                                  B,
                                  " 件あります",
                              ...
                              s.jsx("p", {
                                className:
                                  "mt-1 text-sm leading-6 text-[#7a4540]",
                                children:
                      ...
                      s.jsx("a", {
                        ...
                        className:
                          "inline-flex min-h-11 shrink-0 items-center justify-center rounded-full bg-[#9f2d25] px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#80231d]",
                        children: "対象商品を確認",
                      }),
                    ],
                  })
                ...
                children: [
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, s.jsxs)("p", {
                        className:
                          "text-sm font-semibold tabular-nums text-lien-muted",
                        children: [V.length, "件"],
                      }),
                    ],
                  }),
                    ...
                    ? (0, s.jsxs)(s.Fragment, {
                        children: [
                          s.jsx("div", {
                            ...
                            children: V.map((e) => {
                              let t = A(e.concernTags),
                                a = "ADMIN" === h.role && 0 === e.recentPurchaseCount;
                              return (0, s.jsxs)(
                                "article",
                                {
                                  id: `product-${e.id}`,
                                  className: `scroll-mt-28 rounded-[22px] border bg-white p-4 shadow-lien-sm transition ${F?.id === e.id ? "border-[#8aa58a] bg-[#f7fbf5] ring-4 ring-[#dce8d9]" : a ? "border-[#e8a7a1] bg-[#fffafa]" : "border-lien"}`,
                                  children: [
                                    (0, s.jsxs)("div", {
                                      className:
                                      ...
                                      children: [
                                        (0, s.jsxs)("div", {
                                          ...
                                          children: [
                                            ...
                                            s.jsx("h3", {
                                              className:
                                                "mt-1 break-words text-base font-semibold text-lien-ink",
                                              children: e.name,
                                            }),
                                            s.jsx("p", {
                                              className:
                                            ...
                                            (0, s.jsxs)("div", {
                                              className:
                                                "mt-2 flex flex-wrap gap-2 text-sm font-semibold tabular-nums text-lien-ink",
                                              children: [
                                                (0, s.jsxs)("span", {
                                                  children: [
                                    ...
                                    e.description
                                      ? s.jsx("p", {
                                          className:
                                            "mt-3 text-sm leading-6 text-lien-muted",
                                          children: e.description,
                                        })
                                      : null,
                                    e.alternativeRecommendation
                                      ? (0, s.jsxs)("div", {
                                          className:
                                            "mt-3 rounded-2xl bg-[#f6efe6] px-3 py-2.5",
                                          children: [
                                            s.jsx("p", {
                                              className:
                                                "text-[11px] font-semibold text-lien-primary",
                                              children: "合わない場合の次候補",
                                            }),
                                            s.jsx("p", {
                                              className:
                                                "mt-1 text-sm leading-6 text-lien-ink",
                                              children:
                                                e.alternativeRecommendation,
                                            }),
                                          ],
                                      ...
                                      ? s.jsx("div", {
                                          ...
                                          children: t.map((e) =>
                                            s.jsx(
                                              ...
                                              {
                                                className:
                                                  "rounded-full bg-lien-soft px-2.5 py-1 text-xs font-semibold text-lien-muted",
                                                children: e,
                                              },
                                              e,
                                            ),
                                    ...
                                    (0, s.jsxs)("div", {
                                      className:
                                        "mt-4 flex min-h-12 flex-wrap items-center justify-between gap-3 border-t border-lien pt-3",
                                      children: [
                                        (0, s.jsxs)("div", {
                                          children: [
                                            (0, s.jsxs)("p", {
                                            ...
                                            (0, s.jsxs)("p", {
                                              className: `mt-1 text-[11px] font-semibold ${a ? "text-[#9f2d25]" : "text-lien-muted"}`,
                                              children: [
                                                "直近90日 ",
                                                e.recentPurchaseCount,
                                                "点",
                                        ...
                                        (0, s.jsxs)("div", {
                                          ...
                                          children: [
                                            s.jsx(g, {
                                              action:
                                                N.updateProductMasterAction,
                                              product: { ...e, concernTags: t },
                                              categories: M,
                                              tagOptions: R,
                                            }),
                                            s.jsx(f, {
                                              productId: e.id,
                                              productName: e.name,
                                              proposalCount: e._count.proposals,
                                            }),
                                          ],
                                        }),
                                      ],
                          ...
                          s.jsx("div", {
                            className:
                              "hidden overflow-hidden rounded-[22px] border border-lien bg-white shadow-lien-sm md:block",
                            children: s.jsx("div", {
                              className: "overflow-x-auto",
                              children: (0, s.jsxs)("table", {
                                className:
                                  "min-w-full divide-y divide-lien text-sm",
                                children: [
                                  s.jsx("thead", {
                                    className:
                                      "bg-lien-soft text-left text-xs font-semibold text-lien-muted",
                                  ...
                                  s.jsx("tbody", {
                                    ...
                                    children: V.map((e) => {
                                      let t = A(e.concernTags),
                                        a = "ADMIN" === h.role && 0 === e.recentPurchaseCount,
                                        campaignTags = A(e.campaignTags);
                                      return (0, s.jsxs)(
                                        "tr",
                                        {
                                          id: `product-${e.id}`,
                                          className: `scroll-mt-28 align-top text-lien-muted transition hover:bg-[#fffaf6] ${F?.id === e.id ? "bg-[#f2f8ef] ring-2 ring-inset ring-[#8aa58a]" : a ? "bg-[#fffafa] shadow-[inset_4px_0_0_#c3483f]" : ""}`,
                                          children: [
                                            (0, s.jsxs)("td", {
                                              ...
                                              children: [
                                                ...
                                                s.jsx("p", {
                                                  className:
                                                    "mt-1 font-semibold text-lien-ink",
                                                  children: e.name,
                                                }),
                                                s.jsx("div", {
                                                  className: "mt-2",
                                                ...
                                                e.alternativeRecommendation
                                                  ? (0, s.jsxs)("p", {
                                                      className:
                                                        "mt-2 rounded-xl bg-[#f6efe6] px-2.5 py-2 text-xs leading-5 text-lien-ink",
                                                      children: [
                                                        s.jsx("span", {
                                                          className:
                                                            "font-semibold text-lien-primary",
                                                          children: "次候補: ",
                                                        }),
                                                        e.alternativeRecommendation,
                                                      ],
                                            ...
                                            (0, s.jsxs)("td", {
                                              className:
                                                "whitespace-nowrap px-4 py-4 text-right font-semibold tabular-nums text-lien-ink",
                                              children: [
                                                e.retailPrice.toLocaleString(
                                                  "ja-JP",
                                                ),
                                            ...
                                            (0, s.jsxs)("td", {
                                              className: `whitespace-nowrap px-4 py-4 text-right font-semibold tabular-nums ${e.stockQuantity <= 3 ? "text-[#884039]" : "text-[#466349]"}`,
                                              children: [e.stockQuantity, "点"],
                                            }),
                                            s.jsx("td", {
                                              className: "max-w-md px-4 py-4",
                                              children: s.jsx("div", {
                                            ...
                                            (0, s.jsxs)("td", {
                                              className:
                                                "px-4 py-4 text-right font-semibold tabular-nums text-lien-ink",
                                              children: [
                                                (0, s.jsxs)("p", {
                                                  children: [
                                                    e.purchaseCount,
                                                    s.jsx("span", {
                                                      className:
                                                        "ml-1 text-xs text-lien-muted",
                                                      children: "点",
                                                    }),
                                                  ],
                                                }),
                                                (0, s.jsxs)("p", {
                                                  className: `mt-1 whitespace-nowrap text-[11px] ${a ? "text-[#9f2d25]" : "text-lien-muted"}`,
                                                  children: [
                                                    "90日 ",
                                                    e.recentPurchaseCount,
                                                    "点",
