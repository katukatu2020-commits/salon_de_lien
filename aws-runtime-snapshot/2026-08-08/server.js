...
function chatHtml(audience, session) {
  ...
  const shell = `<aside class="admin-sidebar"><div class="admin-brand"><b>Salon de Lien</b><small>既存客を動かす美容室CRM</small></div><nav class="admin-nav" aria-label="管理画面ナビゲーション"><a href="/admin/appointments">予約カレンダー</a><a class="active" href="/admin/customers">顧客・チャット・配信</a><a href="/admin/products?section=menus">メニュー・商品棚・集計</a><a href="/admin/community">スタイル共有</a><a href="/admin/owner-analytics">経営分析</a></nav><div class="admin-sidebar-footer">今日の接客を、次の関係へ。</div></aside><div class="admin-stage"><div class="admin-topbar"><div class="admin-topbar-title"><small>Salon de Lien</small><b>顧客・チャット・配信</b></div><div class="admin-user"><a href="/admin/account" aria-label="アカウント設定"><span>👤</span><span>${displayName}</span></a><a class="gear" href="/admin/settings" aria-label="設定">⚙</a></div></div>`
