...
function chatHtml(audience, session) {
  ...
  const shellCss = `<style>
    body{display:flex;min-height:100vh;background:#faf6ef}.admin-sidebar{position:fixed;inset:0 auto 0 0;width:255px;background:#fffdf9;border-right:1px solid #e5d8cb;z-index:20;display:flex;flex-direction:column}.admin-brand{height:77px;padding:15px 16px;display:flex;align-items:center;gap:11px;border-bottom:1px solid #eadfd4}.brand-mark{width:42px;height:42px;border:1px solid #dfcdbd;border-radius:50%;display:grid;place-items:center;color:#9b5545;font-family:serif;font-style:italic;background:#fff}.admin-brand b{display:block;font:700 17px Georgia,serif;color:#2d201b}.admin-brand small{display:block;color:#806e64;font-size:11px;margin-top:2px}.admin-nav{display:grid;gap:5px;padding:17px 10px}.admin-nav a{display:flex;align-items:center;gap:12px;padding:12px 14px;border-radius:16px;color:#66544b;font-size:14px}.admin-nav a:hover{background:#f6ede7}.admin-nav a.active{background:#9c5344;color:#fff;box-shadow:0 2px 5px #6b39262b}.nav-icon{width:18px;text-align:center;opacity:.8}.admin-sidebar-footer{margin:auto 12px 14px;border-radius:18px;overflow:hidden;background:#e9ded2;padding:70px 12px 12px;color:#fff;font-size:12px;font-weight:700;background:linear-gradient(0deg,#5d4037aa,#ffffff05),url('/brand/salon-interior.jpg') center/cover}.admin-stage{width:100%;min-width:0;margin-left:255px}.admin-topbar{height:70px;background:#fffdf9;border-bottom:1px solid #e6d9cc;display:flex;align-items:center;gap:18px;padding:0 26px;position:sticky;top:0;z-index:10}.admin-topbar-title{min-width:145px}.admin-topbar-title small{display:block;color:#9a7c6e;font-size:11px}.admin-topbar-title b{font-size:14px}.top-search{height:44px;flex:1;max-width:580px;border:1px solid #e3d4c7;border-radius:999px;background:white;color:#aa9a91;padding:0 18px;display:flex;align-items:center}.admin-user{margin-left:auto;display:flex;align-items:center;gap:10px}.admin-user a,.shortcut{display:flex;align-items:center;gap:7px;border:1px solid #e1d2c5;border-radius:999px;padding:9px 13px;background:white;color:#5d4037;font-size:13px}.admin-user .gear{width:42px;height:42px;justify-content:center;padding:0;font-size:18px}.customer-tabs{max-width:1216px;margin:20px auto 0;display:grid;grid-template-columns:repeat(3,1fr);gap:4px;padding:4px;border:1px solid #e3d4c7;border-radius:18px;background:white}.customer-tabs a{min-height:46px;display:flex;align-items:center;justify-content:center;border-radius:14px;color:#6f5d54;font-size:14px}.customer-tabs a.active{background:#9c5344;color:white}.chat-local-header{display:none!important}.admin-stage .wrap{max-width:1216px;padding:24px 0 36px}.admin-stage .hero{border-radius:22px;background:linear-gradient(135deg,#fffdf9,#f7efe7);padding:25px 28px}.admin-stage .hero h1{font-family:Georgia,'Yu Mincho',serif;font-size:30px}.admin-stage .panel{border-radius:20px;box-shadow:0 8px 24px #5c403414}.admin-stage .grid{grid-template-columns:310px minmax(0,1fr);gap:16px}.admin-stage .messages{height:54vh}.admin-stage .send textarea{min-height:58px}.admin-stage .primary{background:#9c5344}@media(max-width:900px){.admin-sidebar{width:220px}.admin-stage{margin-left:220px}.top-search{display:none}}@media(max-width:700px){body{display:block}.admin-sidebar{display:none}.admin-stage{margin-left:0}.admin-topbar{height:62px;padding:0 12px}.admin-topbar-title small,.shortcut{display:none}.admin-user span{display:none}.customer-tabs{margin:10px 10px 0}.admin-stage .wrap{padding:14px 10px}.admin-stage .grid{grid-template-columns:1fr}}
  </style>`
  const shell = `<aside class="admin-sidebar"><div class="admin-brand"><div class="brand-mark">L</div><div><b>Salon de Lien</b><small>既存客を動かす美容室CRM</small></div></div><nav class="admin-nav" aria-label="管理画面ナビゲーション"><a href="/admin/appointments"><span class="nav-icon">▦</span>予約カレンダー</a><a class="active" href="/admin/customers"><span class="nav-icon">♙</span>顧客・チャット・配信</a><a href="/admin/products?section=menus"><span class="nav-icon">◇</span>メニュー・商品棚・集計</a><a href="/admin/community"><span class="nav-icon">▧</span>スタイル共有</a><a href="/admin/owner-analytics"><span class="nav-icon">▥</span>経営分析</a></nav><div class="admin-sidebar-footer">今日の接客を、次の関係へ。</div></aside><div class="admin-stage"><div class="admin-topbar"><div class="admin-topbar-title"><small>Salon de Lien</small><b>顧客・チャット・配信</b></div><div class="top-search">⌕　顧客名・電話・メモで検索</div><span class="shortcut">⌘　Ctrl K</span><div class="admin-user"><a href="/admin/account" aria-label="アカウント設定"><span>管</span><span>${displayName}</span></a><a class="gear" href="/admin/settings" aria-label="設定">⚙</a></div></div><nav class="customer-tabs" aria-label="顧客ページ切替"><a href="/admin/customers">♙　顧客管理</a><a class="active" href="/admin/customers/messages/chat">▣　チャット</a><a href="/admin/customers/messages">♧　配信</a></nav>`
